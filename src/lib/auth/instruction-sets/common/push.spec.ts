...
testOperator(
  ...
  'pushDataConstant: OP_DATA_1 works',
  'OP_DATA_1 0x2a',
...
testOperator(
  ...
  'pushDataConstant: OP_DATA_5 works',
  'OP_DATA_5 0x050a0f1419',
  'Push the next 5 bytes onto the stack.',
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_DATA_5, 5, 10, 15, 20, 25])
    },
...
testOperator(
  ...
  'pushDataConstant: OP_DATA_6 errors when insufficient bytes to push',
  'OP_DATA_6 0x050a0f1419[missing 1 byte]',
  'Push the next 6 bytes onto the stack.',
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_DATA_6, 5, 10, 15, 20, 25])
    },
    {
